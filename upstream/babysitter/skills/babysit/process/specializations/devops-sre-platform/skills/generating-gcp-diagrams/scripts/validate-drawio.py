...
class DrawIOValidator:
    ...
    def _validate_gcp_shapes(self, root):
        ...
        valid_gcp_shapes = {
            ...
            'app_engine', 'container_engine', 'container_builder', 'container_registry',
            # Data & Analytics
            'bigquery', 'cloud_sql', 'cloud_firestore', 'cloud_spanner',
            'cloud_bigtable', 'cloud_memorystore', 'memorystore',
            'cloud_dataflow', 'cloud_dataproc', 'cloud_composer',
            # Storage
            'cloud_storage', 'cloud_filestore', 'filestore', 'persistent_disk',
            # Networking
            'virtual_private_cloud', 'cloud_load_balancing', 'cloud_cdn', 'cloud_dns',
            'cloud_armor', 'cloud_nat', 'gateway',
            # AI/ML
            'vertexai', 'ai_platform', 'cloud_machine_learning',
            'cloud_vision_api', 'vision_api', 'cloud_natural_language_api', 'natural_language_api',
            'cloud_speech_api', 'speech_to_text',
            # Messaging & Integration
            'cloud_pubsub', 'pubsub', 'cloud_tasks', 'workflows', 'eventarc',
            'cloud_scheduler',
            # Operations
            'cloud_logging', 'logging', 'cloud_monitoring', 'cloud_trace', 'trace',
            'error_reporting',
            # Security
            'key_management_service',
            # API Management
            'apigee', 'apigee_api_platform', 'api_gateway',
            # Utility / Platform
