...
- Run local mining report: `npm run mine:process`
- Output files:
  - `.a5c/reports/process-mining-latest.json`
  - `.a5c/reports/process-mining-latest.md`
- Includes:
  - per-run completion and lifecycle coverage
  - effect requested/resolved integrity checks
  - effect duration percentiles by kind
  - hook activity and score signal distribution
